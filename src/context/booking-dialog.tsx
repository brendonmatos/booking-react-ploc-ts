...
export function useDialogFormBooking() {
	...
	if (!context) {
		throw new Error(
			"useDialogFormBooking must be used within a DialogFormBookingProvider",
		);
	}
	return context;
}

export function DialogFormBookingViewProvider({
	children,
	place,
}: { children: React.ReactNode; place: Place }) {
...
export const DialogFormBookingContext = createContext<
	ReturnType<typeof useBookingDialogState> | undefined
>(undefined);
