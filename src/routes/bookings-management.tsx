...
export function BookingsManagement() {
  const { place, bookingsReactive } = useLoaderData() as ReturnType<typeof bookingsManagementLoader> 
  ...
  return (<DialogFormBookingViewProvider place={place}>
    <PlaceCardContent place={place} orientation="horizontal">
      <CreateBookingButton />
    </PlaceCardContent>
    <div className="mt-8">
      {isBookingsEmpty && <EmptyState title="No bookings yet" description="Create a new booking to get started">
        <CreateBookingButton />
      </EmptyState> || <BookingsList items={bookings} />}
    </div>
